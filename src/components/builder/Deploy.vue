    ...
    <section v-if="deploy_open" class="modal br-pill-ns">
        ...
        <div id="tab-contents">
            ...
            <Tab name="hosted" :selected="active_tab == 'hosted'">
                ...
                <pre><a href="https://thresh.tools/?gh=davidheineman/salsa/main/interface/salsa.yml" target="_blank">thresh.tools/?gh=davidheineman/salsa/main/interface/salsa.yml</a></pre>
                <hr />
                ...
                <pre><a href="https://thresh.tools/?hf=davidheineman/salsa/main/interface/salsa.yml" target="_blank">thresh.tools/?hf=davidheineman/salsa/main/interface/salsa.yml</a></pre>
                <hr />
                ...
                <p>For example:</p>
                <pre><a href='https://thresh.tools/?gh=davidheineman/salsa/main/interface/salsa.yml&amp;d=davidheineman/salsa/main/interface/example_data.json' target="_blank">thresh.tools/?gh=davidheineman/salsa/main/interface/salsa.yml&amp;d=davidheineman/salsa/main/interface/example_data.json</a></pre>
